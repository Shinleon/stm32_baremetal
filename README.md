...
I am unsure where the led pin is in the reference doc; looking at [this](https://wiki.st.com/stm32mcu/wiki/STM32StepByStep:Step2_Blink_LED) tutorial and then reading the autogenerated code may help
